...
# BatchedDatapoint lives in collator upstream; data_misc re-defines it and is
# dependency-light, so we source it from there to avoid vendoring the data stack.
